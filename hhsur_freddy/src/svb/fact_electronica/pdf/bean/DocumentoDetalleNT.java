...
public class DocumentoDetalleNT {
    private String item;
    ...
    public DocumentoDetalleNT(String item, String cantidad, String unidad, String descripcion, String p_unitario, String subtotal) {
        this.item = item;
