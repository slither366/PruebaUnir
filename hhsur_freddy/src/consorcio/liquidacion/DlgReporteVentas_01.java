...
public class DlgReporteVentas_01 extends JDialog {
    private static final Logger log = LoggerFactory.getLogger(DlgReporteVentas_01.class);

    private FarmaTableModel modelRpt_00,modelRpt_01,modelRpt_02,modelRpt_03,modelRpt_04,modelRpt_05,
        modelRpt_TOTAL;
    ...
    private JPanel pblListaCero = new JPanel();
    private JScrollPane jScrollPane4 = new JScrollPane();
    private JTable tblRptCero = new JTable();
    private JPanel jPanel2 = new JPanel();
    private JScrollPane jScrollPane5 = new JScrollPane();
    private JTable tblTotalUnido = new JTable();

    public DlgReporteVentas_01() {
        this(null, "", false);
    }

    public DlgReporteVentas_01(Frame parent, String title, boolean modal) {
    ...
    private void jbInit() throws Exception {
        ...
        this.setTitle("Reporte Total Ventas Version 1");
        ...
        btnPeriodo.setText("Fecha Venta");
        ...
        pblListaCero.setLayout(null);
        jScrollPane4.setBounds(new Rectangle(5, 10, 1435, 420));
        jPanel2.setLayout(null);
        jScrollPane5.setBounds(new Rectangle(5, 10, 1430, 415));
        scpListaAgrupadaAtencion.getViewport().add(tblRpt_01, null);
        pnlListaAgrupada.add(scpListaAgrupadaAtencion, null);
        jTabbedPane1.addTab("Total", jPanel2);
        jTabbedPane1.addTab("Resumen Total", pblListaCero);
        ...
        jScrollPane5.getViewport().add(tblTotalUnido, null);
        jPanel2.add(jScrollPane5, null);
        
        jScrollPane4.getViewport().add(tblRptCero, null);
        pblListaCero.add(jScrollPane4, null);
    ...
    private void initTableListaRegistroVentas() {
        ...
        modelRpt_TOTAL =
                new FarmaTableModel(ConstantsReporteAtencion.columnsListaVenta_TOTALUNIDO, 
                                    ConstantsReporteAtencion.defaultValuesListaVenta_TOTALUNIDO,
                                    0);
        FarmaUtility.initSimpleList(tblTotalUnido, modelRpt_TOTAL,
                                    ConstantsReporteAtencion.columnsListaVenta_TOTALUNIDO);
        TableRowFilterSupport.forTable(tblTotalUnido).searchable(true).apply();
        
        modelRpt_00 =
                new FarmaTableModel(ConstantsReporteAtencion.columnsListaVenta_00, ConstantsReporteAtencion.defaultValuesListaVenta_00,
                                    0);
        FarmaUtility.initSimpleList(tblRptCero, modelRpt_00,
                                    ConstantsReporteAtencion.columnsListaVenta_00);
        TableRowFilterSupport.forTable(tblRpt_01).searchable(true).apply();
        
        modelRpt_01 =
                new FarmaTableModel(ConstantsReporteAtencion.columnsListaVenta_01, ConstantsReporteAtencion.defaultValuesListaVenta_01,
                                    0);
        FarmaUtility.initSimpleList(tblRpt_01, modelRpt_01,
                                    ConstantsReporteAtencion.columnsListaVenta_01);
        TableRowFilterSupport.forTable(tblRpt_01).searchable(true).apply();
        
        
        modelRpt_02 =
                new FarmaTableModel(ConstantsReporteAtencion.columnsListaVenta_02, ConstantsReporteAtencion.defaultValuesListaVenta_02,
                                    0);
        FarmaUtility.initSimpleList(tblRpt_02, modelRpt_02,
                                    ConstantsReporteAtencion.columnsListaVenta_02);
        TableRowFilterSupport.forTable(tblRpt_02).searchable(true).apply();
        
        modelRpt_03 =
                new FarmaTableModel(ConstantsReporteAtencion.columnsListaVenta_03, ConstantsReporteAtencion.defaultValuesListaVenta_03,
                                    0);
        FarmaUtility.initSimpleList(tblRpt_03, modelRpt_03,
                                    ConstantsReporteAtencion.columnsListaVenta_03);
        TableRowFilterSupport.forTable(tblRpt_03).searchable(true).apply();
        

        modelRpt_04 =
                new FarmaTableModel(ConstantsReporteAtencion.columnsListaVenta_04, ConstantsReporteAtencion.defaultValuesListaVenta_04,
                                    0);
        FarmaUtility.initSimpleList(tblProdNormal, modelRpt_04,
                                    ConstantsReporteAtencion.columnsListaVenta_04);
        TableRowFilterSupport.forTable(tblProdNormal).searchable(true).apply();

        modelRpt_05 =
                new FarmaTableModel(ConstantsReporteAtencion.columnsListaVenta_05, ConstantsReporteAtencion.defaultValuesListaVenta_05,
                                    0);
        FarmaUtility.initSimpleList(tblProdEspecial, modelRpt_05,
                                    ConstantsReporteAtencion.columnsListaVenta_05);
    ...
    private void cargaRegistroVentas(String pIniVenta,String pFinVenta) {
        try {
            ...
            DBReportesAtencion.getLista_VENTA_01(modelRpt_01,
            ...
            if (tblRpt_01.getRowCount() <= 0) {
               ...
               // lblRegistros.setText("" + tblRpt_01.getRowCount());
                ...
                tblTotalUnido.setRowSorter(null);
                DBReportesAtencion.getLista_VENTA_TOTALUNIDO(modelRpt_TOTAL,
                                                            VariablesReporteAtencion.vFechaInicio,
                                                            VariablesReporteAtencion.vFechaFin, 
                                                            "000",
                FarmaLoadCVL.getCVLCode(cmbEspecialidad.getName(), cmbEspecialidad.getSelectedIndex()),
                ...
                tblRptCero.setRowSorter(null);
                DBReportesAtencion.getLista_VENTA_00(modelRpt_00,
                                                            VariablesReporteAtencion.vFechaInicio,
                                                            VariablesReporteAtencion.vFechaFin, 
                                                            "000",
                FarmaLoadCVL.getCVLCode(cmbEspecialidad.getName(), cmbEspecialidad.getSelectedIndex()),
                ...
                DBReportesAtencion.getLista_VENTA_02(modelRpt_02,
                                                            VariablesReporteAtencion.vFechaInicio,
                                                            VariablesReporteAtencion.vFechaFin, 
                                                            "000",
                FarmaLoadCVL.getCVLCode(cmbEspecialidad.getName(), cmbEspecialidad.getSelectedIndex()),
                ...
                DBReportesAtencion.getLista_VENTA_03(modelRpt_03,
                                                            VariablesReporteAtencion.vFechaInicio,
                                                            VariablesReporteAtencion.vFechaFin, 
                                                            "000",
                FarmaLoadCVL.getCVLCode(cmbEspecialidad.getName(), cmbEspecialidad.getSelectedIndex()),
                ...
                DBReportesAtencion.getLista_VENTA_04(modelRpt_04,
                                                            VariablesReporteAtencion.vFechaInicio,
                                                            VariablesReporteAtencion.vFechaFin, 
                                                            "000",
                FarmaLoadCVL.getCVLCode(cmbEspecialidad.getName(), cmbEspecialidad.getSelectedIndex()),
                ...
                DBReportesAtencion.getLista_VENTA_05(modelRpt_05,
                                                            VariablesReporteAtencion.vFechaInicio,
                                                            VariablesReporteAtencion.vFechaFin, 
                                                            "000",
                FarmaLoadCVL.getCVLCode(cmbEspecialidad.getName(), cmbEspecialidad.getSelectedIndex()),
    ...
    private void jButton1_actionPerformed(ActionEvent e) {
        ...
        if(tblRpt_01.getRowCount()<=0){
            ...
            try {
                ...
                DefaultTableModel dtm_0 = new DefaultTableModel();
                ...
                for (int a = 0; a < ConstantsReporteAtencion.columnsListaVenta_00.length; a++) {
                    FarmaColumnData vAux = ConstantsReporteAtencion.columnsListaVenta_00[a];
                    if (vAux.m_width > 0) {
                        dtm_0.addColumn(vAux.m_title);
                        cantidad++;
                    }
                }
                Vector<String> dtmrow = null;
                dtmrow = new Vector<String>();
                for (int i = 0; i < ConstantsReporteAtencion.columnsListaVenta_00.length; i++) {
                    FarmaColumnData vAux = ConstantsReporteAtencion.columnsListaVenta_00[i];
                    if (vAux.m_width > 0) {
                        dtmrow.add(vAux.m_title);
                    }
                }
                dtm_0.addRow(dtmrow);
                for (int i = 0; i < tblRptCero.getRowCount(); i++) {
                    dtmrow = new Vector<String>();
                    for (int j = 0; j < cantidad; j++) {
                        dtmrow.add(tblRptCero.getValueAt(i, j).toString());
                ...
                cantidad = 0;
                    ...
                    for (int a = 0; a < ConstantsReporteAtencion.columnsListaVenta_01.length; a++) {
                        FarmaColumnData vAux = ConstantsReporteAtencion.columnsListaVenta_01[a];
                        if (vAux.m_width > 0) {
                            dtm_1.addColumn(vAux.m_title);
                            cantidad++;
                        }
                    }
                    Vector<String> dtmrow_1 = null;
                    dtmrow_1 = new Vector<String>();
                    for (int i = 0; i < ConstantsReporteAtencion.columnsListaVenta_01.length; i++) {
                        FarmaColumnData vAux = ConstantsReporteAtencion.columnsListaVenta_01[i];
                        if (vAux.m_width > 0) {
                            dtmrow_1.add(vAux.m_title);
                        }
                    }
                    dtm_1.addRow(dtmrow_1);
                    for (int i = 0; i < tblRpt_01.getRowCount(); i++) {
                        dtmrow_1 = new Vector<String>();
                        for (int j = 0; j < cantidad; j++) {
                            dtmrow_1.add(tblRpt_01.getValueAt(i, j).toString());
                ...
                cantidad = 0;
                    ...
                    for (int a = 0; a < ConstantsReporteAtencion.columnsListaVenta_02.length; a++) {
                        FarmaColumnData vAux = ConstantsReporteAtencion.columnsListaVenta_02[a];
                        if (vAux.m_width > 0) {
                    ...
                    for (int i = 0; i < ConstantsReporteAtencion.columnsListaVenta_02.length; i++) {
                        FarmaColumnData vAux = ConstantsReporteAtencion.columnsListaVenta_02[i];
                        if (vAux.m_width > 0) {
                ...
                cantidad = 0;
                    ...
                    for (int a = 0; a < ConstantsReporteAtencion.columnsListaVenta_04.length; a++) {
                        FarmaColumnData vAux = ConstantsReporteAtencion.columnsListaVenta_04[a];
                        if (vAux.m_width > 0) {
                    ...
                    for (int i = 0; i < ConstantsReporteAtencion.columnsListaVenta_04.length; i++) {
                        FarmaColumnData vAux = ConstantsReporteAtencion.columnsListaVenta_04[i];
                        if (vAux.m_width > 0) {
                    ...
                    for (int i = 0; i < tblProdNormal.getRowCount(); i++) {
                        dtmrow_3 = new Vector<String>();
                        for (int j = 0; j < cantidad; j++) {
                            dtmrow_3.add(tblProdNormal.getValueAt(i, j).toString());
                ...
                cantidad = 0;
                    ...
                    for (int a = 0; a < ConstantsReporteAtencion.columnsListaVenta_05.length; a++) {
                        FarmaColumnData vAux = ConstantsReporteAtencion.columnsListaVenta_05[a];
                        if (vAux.m_width > 0) {
                    ...
                    for (int i = 0; i < ConstantsReporteAtencion.columnsListaVenta_05.length; i++) {
                        FarmaColumnData vAux = ConstantsReporteAtencion.columnsListaVenta_05[i];
                        if (vAux.m_width > 0) {
                    ...
                    for (int i = 0; i < tblProdEspecial.getRowCount(); i++) {
                        dtmrow_4 = new Vector<String>();
                        for (int j = 0; j < cantidad; j++) {
                            dtmrow_4.add(tblProdEspecial.getValueAt(i, j).toString());
                ...
                cantidad = 0;
                    ...
                    for (int a = 0; a < ConstantsReporteAtencion.columnsListaVenta_03.length; a++) {
                        FarmaColumnData vAux = ConstantsReporteAtencion.columnsListaVenta_03[a];
                        if (vAux.m_width > 0) {
                    ...
                    for (int i = 0; i < ConstantsReporteAtencion.columnsListaVenta_03.length; i++) {
                        FarmaColumnData vAux = ConstantsReporteAtencion.columnsListaVenta_03[i];
                        if (vAux.m_width > 0) {
                    ...
                    for (int i = 0; i < tblRpt_03.getRowCount(); i++) {
                        dtmrow_5 = new Vector<String>();
                        for (int j = 0; j < cantidad; j++) {
                            dtmrow_5.add(tblRpt_03.getValueAt(i, j).toString());
                ...
                // RPT 0
                Sheet sheet = wb.createSheet("Resumen Total");
                Row row = null;
                Cell cell = null;
                for (int i = 0; i < dtm_0.getRowCount(); i++) {
                    row = sheet.createRow(i);
                    for (int j = 0; j < dtm_0.getColumnCount(); j++) {
                        cell = row.createCell(j);
                        cell.setCellValue((String)dtm_0.getValueAt(i, j));
                    }
                }

                // RPT 1
                Sheet sheet1 = wb.createSheet("Agrupado por dia");
                Row row1 = null;
                Cell cell1 = null;
                for (int i = 0; i < dtm_1.getRowCount(); i++) {
                    row1 = sheet1.createRow(i);
                    for (int j = 0; j < dtm_1.getColumnCount(); j++) {
                        cell1 = row1.createCell(j);
                        cell1.setCellValue((String)dtm_1.getValueAt(i, j));
                    }
                }                

                // RPT 2
                Sheet sheet2 = wb.createSheet("agrupado por servicio");
                Row row2 = null;
                Cell cell2 = null;
                for (int i = 0; i < dtm_2.getRowCount(); i++) {
                    ...
                    for (int j = 0; j < dtm_2.getColumnCount(); j++) {
                        ...
                        cell2.setCellValue((String)dtm_2.getValueAt(i, j));
                    }
                }         
                
                // RPT 3
                Sheet sheet3 = wb.createSheet("Serv.Normal");
                Row row3 = null;
                Cell cell3 = null;
                for (int i = 0; i < dtm_3.getRowCount(); i++) {
                    ...
                    for (int j = 0; j < dtm_3.getColumnCount(); j++) {
                        ...
                        cell3.setCellValue((String)dtm_3.getValueAt(i, j));
                    }
                }     
                
                // RPT 4
                Sheet sheet4 = wb.createSheet("Serv.Especial");
                Row row4 = null;
                Cell cell4 = null;
                for (int i = 0; i < dtm_4.getRowCount(); i++) {
                    ...
                    for (int j = 0; j < dtm_4.getColumnCount(); j++) {
                        ...
                        cell4.setCellValue((String)dtm_4.getValueAt(i, j));
                    }
                }  
                
                // RPT 4
                Sheet sheet5 = wb.createSheet("Detallado");
                Row row5 = null;
                Cell cell5 = null;
                for (int i = 0; i < dtm_5.getRowCount(); i++) {
                    row5 = sheet5.createRow(i);
                    for (int j = 0; j < dtm_5.getColumnCount(); j++) {
                        cell5 = row5.createCell(j);
                        cell5.setCellValue((String)dtm_5.getValueAt(i, j));
                    }
                }                
                ...
                pRuta = "D:\\"+"total_venta_"+getIP()+"_"+getDiaHora()+".xls";
        ...
        */
            ...
            if(pFechaAtencion==false||pFechaVenta==false){
                ...
                if(pPermiteBuscar){
                    ...
                    FechaFin_venta  = "X";
                    //buscaRegistroVentas(FechaInicio, FechaFin,FechaInicio_Venta,FechaFin_venta);
                    DlgProcesoVentaHH dlgProcesar = new DlgProcesoVentaHH(myParentFrame, "", true,FechaInicio, FechaFin,this);
                    dlgProcesar.mostrar();
                }
