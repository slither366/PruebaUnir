...
public class DlgListaProcedimiento extends JDialog {
    
    private String codProdRecetaSelect = "";
    
    private static final Logger log = LoggerFactory.getLogger(DlgListaProcedimiento.class);
    ...
    public DlgListaProcedimiento() {
        this(null, "", false);
    }

    public DlgListaProcedimiento(Frame parent, String title, boolean modal) {
    ...
    public DlgListaProcedimiento(Frame parent, String title, boolean modal,boolean vActReceta) {
        super(parent, title, modal);
        myParentFrame = parent;
    ...
    private void jbInit() throws Exception {
        ...
        this.setSize(new Dimension(1308, 786));
        ...
        jScrollPane2.setBounds(new Rectangle(20, 420, 935, 260));
        jScrollPane2.setBackground(new Color(255, 130, 14));
        jPanel2.setBounds(new Rectangle(20, 400, 935, 20));
        ...
        jScrollPane1.setBounds(new Rectangle(20, 100, 935, 300));
        jScrollPane1.setBackground(new Color(255, 130, 14));
        pnlIngresarProductos.setBounds(new Rectangle(20, 0, 1265, 55));
        ...
        lblF11.setBounds(new Rectangle(610, 690, 130, 35));
        lblEsc.setText("[ ESC ] Cerrar");
        lblEsc.setBounds(new Rectangle(755, 690, 145, 35));

        lblEnter.setText("[ ENTER ] Seleccionar");
        lblEnter.setBounds(new Rectangle(25, 690, 135, 35));
        jPanel4.setBounds(new Rectangle(630, 55, 325, 45));
        jPanel4.setBackground(new Color(0, 114, 169));
        jPanel4.setBorder(BorderFactory.createLineBorder(Color.black, 1));
        jPanel4.setLayout(null);
        pnlTitle1.setBounds(new Rectangle(1505, 330, 340, 30));
        ...
        jScrollPane3.setBounds(new Rectangle(970, 55, 315, 660));
    ...
    private void initTableProductosSustitutos() {
        ...
        tblModeLaboratorio = 
                new FarmaTableModel(ConstantsCentroMedico.columnsListaLaboratorio, ConstantsCentroMedico.defaultValuesListaLaboratorio, 
                                    0);
   ...
   */
    ...
    private void clonarListadoProductos() {
        ...
        for (int i = 0; 
             i < VariablesCentroMedico.tableModelListaProductosEmpresa.data.size(); 
             i++) {
...
*/
    ...
    private void filtrarBusquedaGoogle() {
        ...
        String pRuc =  FarmaUtility.getValueFieldArrayList(tblModeLaboratorio.data,pos, 0);
        ...
        if(!condicion.equals("") && condicion.length() > 0){
            ...
            while(iterator.hasNext()){
                ...
                if(pRuc.equalsIgnoreCase("0")){
                    if(descProd.contains(condicion)||pCodigo.contains(condicion)){
                        filteredCollection.add(fila);
                    }
                }
                else
                    if((descProd.contains(condicion)||pCodigo.contains(condicion))&&pCodRUC.equalsIgnoreCase(pRuc)){
                        filteredCollection.add(fila);
                    }
            }
        ...
        if(pRuc.equalsIgnoreCase("0")){
            ...
            if(!condicion.equals("") && condicion.length() > 0){
                ...
                while(iterator.hasNext()){
                    ...
                    if((descProd.startsWith(condicion) || pCodigo.endsWith(condicion))&&valor_ruc.contains(pRuc)){
                        filteredCollection.add(fila);
                    }
