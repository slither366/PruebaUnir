 ...
 *
 */
public class DlgSeleccionMoneda
  extends JDialog{
/* ************************************************************************** */
/*                           DECLARACION PROPIEDADES                          */
/* ************************************************************************** */
  private static final Logger log = LoggerFactory.getLogger(DlgSeleccionMoneda.class);
  ...
  private JLabelFunction lblF11 = new JLabelFunction();
    ...
    public boolean vSoles = false;
    public boolean vDolares = true;

    /* ************************************************************************** */
/*                              CONSTRUCTORES                                 */
/* ************************************************************************** */

  public DlgSeleccionMoneda(){
    try
    {
      jbInit();
    }
  ...
  public DlgSeleccionMoneda(Frame parent, String title, boolean modal){
...
/* ************************************************************************** */
    ...
    throws Exception
  {
    ...
    lblF11.setText("[ Esc ] Cerrar");
        ...
        btnImprimir.setText("<html><center>Soles<br>S/</cemter></html>");
        ...
        btnPDF.setText("<html><center>D\u00f3lares<br>$</center></html>");
...
/* ************************************************************************** */
  ...
  private void this_windowClosing(WindowEvent e)
  {
    FarmaUtility.showMessage(this, 
                             "Debe de seleccionar la MONEDA de forma OBLIGATORIA.", 
                             null);
  }
...
/* ************************************************************************** */
  ...
  public void setMensaje(String pMensaje)
  {
    ...
    public void setVSoles(boolean vCotiza) {
        this.vSoles = vCotiza;
    }

    public boolean isVSoles() {
        return vSoles;
    }

    public void setVDolares(boolean vPedido) {
        this.vDolares = vPedido;
    }

    public boolean isVDolares() {
        return vDolares;
    }
