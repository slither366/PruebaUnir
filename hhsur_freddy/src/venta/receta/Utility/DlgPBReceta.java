...
//import mifarma.admcentral.compras.reference.ConstantsCompras;
//import mifarma.admcentral.compras.reference.VariablesCompras;


import common.FarmaConstants;
import common.FarmaUtility;

public class DlgPBReceta extends JDialog {
    ...
    public DlgPBReceta(Frame parent, String title, boolean modal,DlgListaProductos dlgAux,
    ...
    private void iniciaProcesoProgressBar(){
        if (trabajador == null) {
            trabajador = new MiWorker(this,dlgCompra,lblAvance,jpbProceso,vCodCia,vCodLocal,vNumReceta);
