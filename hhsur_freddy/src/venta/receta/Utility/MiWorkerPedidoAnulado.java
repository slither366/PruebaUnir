...
public class MiWorkerPedidoAnulado extends SwingWorker<String, Void>{
        
        boolean pEjecutaProceso =  false;
        DlgListaProductos dlgAuxCompra = new DlgListaProductos();
        JDialog dlgAux = new JDialog();
        JLabel lblAuxOut;
        SubProcesosPedidoAnula subProc ;// = new SubProcesos();
        JProgressBar jpbProceso;
        int i=0;
        String pCodCia;
        String pCodLocal;
        String pNumReceta;
        public MiWorkerPedidoAnulado(){
            this(null,null,null,null,null,null,null);
        }
        
        public MiWorkerPedidoAnulado(JDialog dlg,DlgListaProductos dlgCompra,JLabel lblAux,JProgressBar jProgBar,
            ...
            subProc  = new SubProcesosPedidoAnula(dlgCompra);
        }
