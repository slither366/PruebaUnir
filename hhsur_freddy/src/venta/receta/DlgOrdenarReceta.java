...
public class DlgOrdenarReceta extends JDialog {
    private static final Logger log = LoggerFactory.getLogger(DlgOrdenarReceta.class);
    ...
    public DlgOrdenarReceta() {
        this(null, "", false);
    }

    public DlgOrdenarReceta(Frame parent, String title, boolean modal) {
    ...
    private void cargaCombos() {
        FarmaLoadCVL.loadCVLfromArrays(cmbOrden, VariablesReceta.vNombreInHashtableVal, ConstantsReceta.ORDENVAL,
                                       ConstantsReceta.ORDEN, true);
    }
