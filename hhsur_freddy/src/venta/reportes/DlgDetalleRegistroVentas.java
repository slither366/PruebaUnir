...
public class DlgDetalleRegistroVentas extends JDialog 
{
  ...
  /* ************************************************************************ */
    ...
    private void jbInit() throws Exception
    {
        ...
        jLabelFunction1.setBounds(new Rectangle(10, 430, 150, 25));
        jLabelFunction1.setText("[ F4] Ver Comprobante");
        jLabelFunction2.setBounds(new Rectangle(615, 430, 115, 25));
        ...
        jLabelFunction3.setBounds(new Rectangle(425, 430, 125, 25));
        jLabelFunction3.setText("[ F12] Imprimir");
        jLabelFunction4.setBounds(new Rectangle(215, 430, 150, 25));
