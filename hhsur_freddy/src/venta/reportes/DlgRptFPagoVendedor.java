...
public class DlgRptFPagoVendedor extends JDialog 
{
    ...
    private static final Logger log = LoggerFactory.getLogger(DlgRptFPagoVendedor.class);
  ...
  private JLabelFunction lblEsc = new JLabelFunction();
    ...
    public DlgRptFPagoVendedor()
  {
    this(null, "", false);
  }

  public DlgRptFPagoVendedor(Frame parent, String title, boolean modal)
  {
  ...
  private void jbInit() throws Exception
  {
    ...
    this.setTitle("Forma de pago x Vendedor");
    ...
    btnListado.setText("Listado de Forma de Pago");
  ...
  {
    tableModelVentasVendedor = new FarmaTableModel(ConstantsReporte.columnsListaRptFormaPago,ConstantsReporte.defaultValuesListaRptFormaPago,0);
    FarmaUtility.initSimpleList(tblVentasVendedor,tableModelVentasVendedor,ConstantsReporte.columnsListaRptFormaPago);
  }
  ...
  private void cargaRegistroVentasVendedor()
  {
    try
    {
      DBReportes.cargaListaFormaPago(tableModelVentasVendedor,
