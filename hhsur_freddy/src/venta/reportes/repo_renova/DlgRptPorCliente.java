...
public class DlgRptPorCliente  extends JDialog {
    private static final Logger log = LoggerFactory.getLogger(DlgRptPorCliente.class);
    ...
    private JTextField txtDocCliente = new JTextField();
    private JLabel jLabel1 = new JLabel();

    private String pCodProd = "T";

    public DlgRptPorCliente() {
        this(null, "", false);
    }

    public DlgRptPorCliente(Frame parent, String title, boolean modal) {
    ...
    private void jbInit() throws Exception {
        this.setSize(new Dimension(974, 521));
        ...
        pnlCriterioBusqueda.setBounds(new Rectangle(10, 15, 945, 30));
        pnlCriterioBusqueda.setFocusable(false);
        pnlTitulo.setBounds(new Rectangle(10, 50, 945, 20));
        pnlTitulo.setFocusable(false);
        pnlResultados.setBounds(new Rectangle(10, 425, 945, 20));
        pnlResultados.setFocusable(false);
        jScrollPane1.setBounds(new Rectangle(10, 70, 945, 355));
        ...
        txtFechaIni.setBounds(new Rectangle(75, 5, 101, 19));
        ...
        txtFechaFin.setBounds(new Rectangle(200, 5, 101, 19));
        ...
        lblF1.setBounds(new Rectangle(5, 460, 160, 20));
        lblF1.setText("[ F1 ] Ver Datos Generales");
        ...
        lblF9.setBounds(new Rectangle(525, 460, 100, 20));
        lblF9.setText("[ F9 ] Ordenar");
        lblF9.setFocusable(false);
        lblEsc.setBounds(new Rectangle(695, 460, 110, 20));
        ...
        txtDocCliente.setBounds(new Rectangle(380, 5, 130, 20));
        txtDocCliente.addKeyListener(new KeyAdapter() {
                public void keyPressed(KeyEvent e) {
                    txtDocCliente_keyPressed(e);
                }
            });
        jLabel1.setText("DNI / RUC:");
        jLabel1.setBounds(new Rectangle(310, 5, 70, 25));
        ...
        pnlCriterioBusqueda.add(txtDocCliente, null);
    ...
    private void txtFechaFin_keyPressed(KeyEvent e) {
        if (e.getKeyCode() == KeyEvent.VK_ENTER)
            //btnBuscar.doClick();
            FarmaUtility.moveFocus(txtDocCliente);
    ...
    private void busqueda() {
        if (validarCampos()) {
            ...
            if (FechaInicio.length() > 0 || FechaFin.length() > 0) {
                String pDniCliente = txtDocCliente.getText().trim();
                if(pDniCliente.length()>0){
                   ...
                   FarmaUtility.showMessage(this, "Debe ingresar el documento del cliente a buscar", txtFechaIni);                    
            } else
