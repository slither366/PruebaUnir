...
public class ConstantsReporte 
{
  ...
  public static final FarmaColumnData columnsListaRegistroVentas[] = {
	...
	new FarmaColumnData( "Cliente", 280, JLabel.LEFT ),    
...
//    new FarmaColumnData( "Direccion", 100, JLabel.LEFT ),
    new FarmaColumnData( "Ruc", 50, JLabel.RIGHT ),
    new FarmaColumnData( "Hora", 50, JLabel.RIGHT ),
    new FarmaColumnData( "CAJERO",200, JLabel.RIGHT ),
