...
public class DlgRegistroVentas extends JDialog 
{
  ...
  private void jbInit() throws Exception
  {
    ...
    lblF9.setText("[ F9 ] Ordenar");
        ...
        lblF12.setBounds(new Rectangle(600, 545, 165, 20));
      lblF12.setText("[ F12 ] PDF Cotizacion");
   ...
   // jLabelFunction1.setBounds(new Rectangle(280, 370, 130, 20));
    ...
    //jContentPane.add(jLabelFunction1, null);
        ...
        jButton1.setText("[ F5 ] PDF Guia");
        jButton1.setBounds(new Rectangle(805, 545, 165, 20));
        ...
        pnlExpReporte.setBounds(new Rectangle(590, 0, 40, 30));
