...
public class DlgRegistroComision extends JDialog 
{
    private static final Logger log = LoggerFactory.getLogger(DlgRegistroComision.class);
  ...
  private JLabel lblTotalMonto = new JLabel();
    ...
    public DlgRegistroComision()
  {
    this(null, "", false);
  }

  public DlgRegistroComision(Frame parent, String title, boolean modal)
  {
  ...
  {
    tableModelRegistroVentas = new FarmaTableModel(ConstantsReporte.columnsListaRegistroVentasComision,
                                                   ConstantsReporte.defaultValuesListaRegistroVentasComision,0);
    FarmaUtility.initSimpleList(tblRegistroVentas,tableModelRegistroVentas,ConstantsReporte.columnsListaRegistroVentasComision);
  }
   ...
   private void cargaRegistroVentas()
  {
    try
    {
      ...
      DBReportes.cargaListaRegistroVentasComision(tableModelRegistroVentas,VariablesReporte.vFechaInicio, VariablesReporte.vFechaFin,"000");
    ...
    public static void exportExcel (JTable jTable1, String Location) throws FileNotFoundException, IOException {
                   ...
                   for(int j = 0; j < tcm.getColumnCount(); j++) {                       
                      ...
                      cell.setCellStyle(cellStyle);
                           ...
                           FarmaUtility.showMessage(new JDialog(), "Error."+e.getMessage(), null);
                           // TODO: Add catch code
                           e.printStackTrace();
                       }
                   }
                   ...
                   for (int i = 0; i < model.getRowCount(); i++) {
                       ...
                       for (int j = 0; j < model.getColumnCount(); j++) {
                           ...
                           if(j==6||j==15){
                               ...
                               try {
                               cell.setCellValue(Float.parseFloat(model.getValueAt(i, j).toString()));
