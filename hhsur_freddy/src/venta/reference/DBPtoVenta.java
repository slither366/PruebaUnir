 ...
 public static void cargaListaAperturasDia(FarmaTableModel pTableModel) throws SQLException {
  ...
  public static String validaCambioClave() throws SQLException {
    ...
    public static boolean obtieneIndDirMatriz()throws SQLException{
        ...
        ind = "N";//FarmaDBUtility.executeSQLStoredProcedureStr("PTOVENTA_VTA.VTA_F_CHAR_IND_OBT_DIR_MATRIZ()",parametros);
    ...
    */
    ...
    public static void getRolesUsuario(ArrayList pArrayList)throws SQLException{
        parametros=new ArrayList();
        parametros.add(FarmaVariables.vCodGrupoCia);
        parametros.add(FarmaVariables.vCodLocal);
        parametros.add(FarmaVariables.vNuSecUsu);
        log.debug("FARMA_UTILITY.GET_ROLES_USUARIO(?,?,?)"+parametros);
        FarmaDBUtility.executeSQLStoredProcedureArrayList(pArrayList,"FARMA_UTILITY.GET_ROLES_USUARIO(?,?,?)",parametros);
    }
    
    public static String getTipoCambioNuevo(String pFechaCambio,String pTipo)throws SQLException{
        parametros=new ArrayList();
        parametros.add(FarmaVariables.vCodGrupoCia);
        parametros.add(FarmaVariables.vCodCia);
        parametros.add(pFechaCambio);
        parametros.add(pTipo);
        log.debug("FARMA_UTILITY.GET_ROLES_USUARIO(?,?,?)"+parametros);
        return FarmaDBUtility.executeSQLStoredProcedureStr("FARMA_UTILITY.OBTIENE_TIPO_CAMBIO3(?,?,?,?)",parametros);
    }
}
