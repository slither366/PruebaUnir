...
//  public static final String SID = "MFPROD01";
 ...
 //Lista Filtro
  ...
  public static final int TOTAL_LINEAS_POR_FACTURA = 13;
  ...
  public static final String ROL_ASISTENTE_AUDITORIA="036";
    ...
    public static final int TIPO_VENTA  = 1;
    public static final int TIPO_COMPRA = 2; 
    
    public static final FarmaColumnData columnsListaLocalMulti[] = {
    new FarmaColumnData( "Descripcion", 220, JLabel.LEFT ),
    new FarmaColumnData( "RUC", 100, JLabel.CENTER ),
    new FarmaColumnData( "Razon Social", 260, JLabel.CENTER ),
    new FarmaColumnData( "CIA", 0, JLabel.CENTER ),
    new FarmaColumnData( "Codigo", 0, JLabel.LEFT )
          };
    
    public static final Object[] defaultValuesListaLocalMulti = {" ", " ", " "," "," "};    
}
