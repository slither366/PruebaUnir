...
public class DlgFormaPagoHHSur extends JDialog  {
  ...
  private static final Logger log = LoggerFactory.getLogger(DlgFormaPagoHHSur.class);
  ...
  private FarmaTableModel tblModelEspecialidad;
  private FarmaTableModel tblModelDetalleProd;
  ...
  private JLabel lblMsjNumRecarga = new JLabel();
    ...
    private JPanel pnlDetalleFormaPago = new JPanel();
    private JButton jButton2 = new JButton();
    private JScrollPane srcEspecialidad = new JScrollPane();
    private JScrollPane srcDetalleEspecialidad = new JScrollPane();
    private JScrollPane jScrollPane2 = new JScrollPane();
    //private JPanel pnlMedico = new JPanel();
    ...
    private JPanel pnlMedico = new JPanel();
    //private JPanel pnlPaciente = new JPanel();
    ...
    private JButton jButton3 = new JButton(imagePaciente);
    private JPanel pnlPaciente = new JPanel();
   ...
   // private JPanel pnlClienteRUC = new JPanel();
    ...
    private JTable tblDetalleProd = new JTable();
...
// **************************************************************************
  ...
  */
  public DlgFormaPagoHHSur(Frame parent, String title, boolean modal) {
...
// **************************************************************************
 ...
 this.setSize(new Dimension(1120, 558));
    ...
    jContentPane.setSize(new Dimension(554, 504));
        jContentPane.setBounds(new Rectangle(0, 0, 1260, 520));
    ...
    cmbMoneda.setBounds(new Rectangle(275, 35, 90, 20));
    ...
    txtMontoPagado.setBounds(new Rectangle(275, 60, 105, 25));
    ...
    btnAdicionar.setBounds(new Rectangle(260, 90, 120, 30));
    ...
    lblF11.setBounds(new Rectangle(985, 485, 115, 30));
        pnlTotales.setBounds(new Rectangle(400, 75, 185, 140));
    ...
    lblVuelto.setForeground(Color.white);
        lblTipoComprobante.setForeground(SystemColor.window);
    lblTipoComprobante.setFont(new Font("SansSerif", 1, 12));
    lblTipoComprobante.setBounds(new Rectangle(10, 10, 120, 15));
        lblTipoComprobante.setBackground(new Color(198, 198, 198));
    ...
    pnlTotal.setBounds(new Rectangle(0, 145, 1095, 20));
    ...
    txtNroPedido.setFont(new Font("SansSerif", 0, 12));
        txtNroPedido.setBounds(new Rectangle(65, 50, 145, 25));
    ...
    btnPedido.setForeground(Color.white);
        btnPedido.setBounds(new Rectangle(10, 50, 55, 25));
    ...
    lblDolares.setForeground(Color.white);
        lblDolares.setBounds(new Rectangle(515, 55, 70, 20));
    ...
    btnMonto.setBounds(new Rectangle(225, 60, 50, 25));
    ...
    lblFecPed.setForeground(Color.white);
        lblFecPed.setBounds(new Rectangle(1175, 135, 70, 20));
    ...
    btnMoneda.setBounds(new Rectangle(225, 30, 45, 20));
    ...
    lblTipoCambioT.setBounds(new Rectangle(380, 0, 85, 20));
    lblTipoCambioT.setForeground(SystemColor.window);
    lblTipoCambioT.setFont(new Font("SansSerif", 1, 12));
    lblTipoCambio.setBounds(new Rectangle(465, 0, 110, 20));
    lblTipoCambio.setFont(new Font("SansSerif", 1, 12));
    lblTipoCambio.setForeground(SystemColor.window);
    ...
    btnCantidad.setBounds(new Rectangle(615, 65, 60, 20));
    ...
    txtCantidad.setBounds(new Rectangle(695, 65, 90, 20));
    ...
    lblMsjNumRecarga.setBounds(new Rectangle(1385, 260, 125, 20));
        ...
        jButton1.setBounds(new Rectangle(505, 485, 120, 30));
        ...
        jLabel1.setBounds(new Rectangle(370, 35, 70, 15));
        txtNumeroOperacion.setBounds(new Rectangle(440, 35, 145, 20));
        ...
        jPanel3.add(lblTipoComprobante, null);
        jPanel3.add(lblSoles, null);
        jPanel3.add(lblTotalPagar, null);
        jPanel3.add(lblSolesT, null);
        jPanel3.add(lblDolares, null);
        jPanel3.add(lblDolaresT, null);
        jPanel3.add(txtNroPedido, null);
        jPanel3.add(btnPedido, null);
        ...
        jPanel1.add(scrDetallePago, null);
        jPanel1.add(pnlTotales, null);
        jPanel2.add(btnFormaPago, null);
        jPanel2.add(lblTipoCambioT, null);
        jPanel2.add(lblTipoCambio, null);
        jScrollPane1.getViewport();
        pnlTotales.add(lblSaldoT, new XYConstraints(10, 5, 150, 20));
        pnlTotales.add(lblSaldo, new XYConstraints(40, 30, 105, 20));
        pnlTotales.add(lblCoPagoT, new XYConstraints(595, 10, 140, 20));
        pnlTotales.add(lblCoPago, new XYConstraints(740, 10, 105, 20));
        pnlTotales.add(lblVueltoT, new XYConstraints(10, 60, 80, 20));
        pnlTotales.add(lblVuelto, new XYConstraints(40, 95, 105, 20));
        scrDetallePago.getViewport();
        this.getContentPane().add(jContentPane, BorderLayout.CENTER);
        //jContentPane.add(lblF8, null);
        //jContentPane.add(lblF6, null);
        //jContentPane.add(lblF1, null);
        srcDetalleEspecialidad.getViewport().add(tblDetalleProd, null);
        pnlDetalleFormaPago.add(srcDetalleEspecialidad, null);
        srcEspecialidad.getViewport().add(tblEspecialidad, null);
        pnlDetalleFormaPago.add(srcEspecialidad, null);
        pnlDetalleFormaPago.add(pnlTotal, null);
        pnlClienteRUC.add(rbFactura, null);
        pnlClienteRUC.add(rbBoleta, null);
        pnlClienteRUC.add(rbTicket, null);
        ...
        jContentPane.add(pnlPaciente, null);
        jContentPane.add(pnlMedico, null);
        jContentPane.add(jScrollPane2, null);
        jContentPane.add(pnlDetalleFormaPago, null);
        ...
        jContentPane.add(lblFecPed, null);
        txtNumeroOperacion.setEnabled(false);
        //Agregado Por FRAMIREZ  11.05.2012
        pnlDetalleFormaPago.setBounds(new Rectangle(5, 0, 1095, 165));
        pnlDetalleFormaPago.setLayout(null);
        pnlDetalleFormaPago.setBackground(new Color(198, 198, 198));
        jButton2.setText("<html><center>F4 - Limpiar</center></html>");
        jButton2.setBounds(new Rectangle(765, 485, 110, 30));
        srcEspecialidad.setBounds(new Rectangle(5, 5, 410, 140));
        srcDetalleEspecialidad.setBounds(new Rectangle(425, 5, 655, 140));
        jScrollPane2.setBounds(new Rectangle(80, 345, 2, 2));
        pnlMedico.setBounds(new Rectangle(10, 10, 530, 125));
        pnlMedico.setLayout(null);
        pnlMedico.setBorder(BorderFactory.createTitledBorder("Datos de Médico"));
        pnlMedico.setSize(new Dimension(529, 125));
        jLabel2.setText("CMP:");
        jLabel2.setBounds(new Rectangle(80, 15, 40, 20));
        jLabel2.setFont(new Font("Tahoma", 1, 11));
        txtCmp.setBounds(new Rectangle(125, 15, 130, 20));
        ...
        jLabel4.setBounds(new Rectangle(80, 45, 50, 20));
        jLabel4.setFont(new Font("Tahoma", 1, 11));
        txtNombreCompleto.setBounds(new Rectangle(125, 45, 365, 20));
        txtNombreCompleto.addKeyListener(new KeyAdapter() {
                public void keyPressed(KeyEvent e) {
                    txtNombreCompleto_keyPressed(e);
                }
            });
        btnMedico.setBounds(new Rectangle(5, 15, 70, 70));
        btnMedico.addActionListener(new ActionListener() {
                public void actionPerformed(ActionEvent e) {
                    btnMedico_actionPerformed(e);
                }
            });
        pnlMedico.setBounds(new Rectangle(5, 165, 495, 95));
        pnlMedico.setBackground(new Color(214, 214, 214));
        pnlPaciente.setBounds(new Rectangle(10, 165, 530, 115));
        pnlPaciente.setLayout(null);
        pnlPaciente.setBorder(BorderFactory.createTitledBorder("Datos del Paciente"));
        pnlPaciente.setSize(new Dimension(560, 125));
        jLabel5.setText("DNI:");
        jLabel5.setBounds(new Rectangle(105, 25, 35, 15));
        jLabel5.setFont(new Font("Tahoma", 1, 11));
        txtDniPaciente.setBounds(new Rectangle(145, 20, 165, 20));
        jLabel6.setText("Nombre:");
        jLabel6.setBounds(new Rectangle(95, 50, 50, 15));
        jLabel6.setFont(new Font("Tahoma", 1, 11));
        txtNombrePaciente.setText("Debe Ingresar Nombre");
        txtNombrePaciente.setBounds(new Rectangle(150, 50, 265, 15));
        jLabel7.setText("Apellidos:");
        jLabel7.setBounds(new Rectangle(90, 70, 55, 15));
        jLabel7.setFont(new Font("Tahoma", 1, 11));
        txtApellidoPacientePaterno.setText("Debe Ingresar Apellidos");
        txtApellidoPacientePaterno.setBounds(new Rectangle(150, 70, 135, 15));
        txtApellidoPacienteMaterno.setText("jLabel10");
        txtApellidoPacienteMaterno.setBounds(new Rectangle(290, 70, 150, 15));
        jButton3.setBounds(new Rectangle(10, 20, 70, 70));
        jButton3.addActionListener(new ActionListener() {
                public void actionPerformed(ActionEvent e) {
                    jButton2_actionPerformed(e);
                }
            });
        pnlPaciente.setBounds(new Rectangle(5, 260, 495, 95));
        pnlPaciente.setBackground(new Color(214, 214, 214));
        txtNacimientoPaciente.setText("00/00/0000");
        txtNacimientoPaciente.setBounds(new Rectangle(360, 30, 65, 15));
        txtSexoPaciente.setText("Masculino");
        txtSexoPaciente.setBounds(new Rectangle(360, 10, 100, 15));
        ...
        pnlClienteRUC.setBounds(new Rectangle(5, 355, 495, 165));
        pnlClienteRUC.setBackground(new Color(214, 214, 214));
        pnlClienteRUC.setBorder(BorderFactory.createTitledBorder("Datos de Comprobante"));
        lblDocumento.setText("RUC : ");
        lblDocumento.setBounds(new Rectangle(45, 45, 40, 15));
        lblDocumento.setFont(new Font("SansSerif", 1, 11));
        txtRuc.setBounds(new Rectangle(90, 45, 180, 20));
        ...
        lblNombres.setBounds(new Rectangle(10, 75, 75, 15));
        lblNombres.setFont(new Font("SansSerif", 1, 11));
        txtRazonSocial.setBounds(new Rectangle(90, 70, 395, 20));
        ...
        jLabel19.setBounds(new Rectangle(15, 100, 70, 15));
        jLabel19.setFont(new Font("SansSerif", 1, 11));
        txtDireccion.setBounds(new Rectangle(90, 95, 395, 20));
        ...
        jLabel20.setBounds(new Rectangle(35, 130, 50, 15));
        jLabel20.setFont(new Font("SansSerif", 1, 11));
        txtEmail.setBounds(new Rectangle(90, 125, 195, 20));
        ...
        btnSelectCliente.setBounds(new Rectangle(275, 45, 175, 20));
        ...
        rbTicket.setBounds(new Rectangle(25, 20, 85, 20));
        ...
        rbBoleta.setBounds(new Rectangle(190, 20, 85, 20));
        ...
        rbFactura.setBounds(new Rectangle(365, 20, 85, 20));
        ...
        //  pnlMedico.add();
        pnlMedico.add(btnMedico, null);
        pnlMedico.add(txtNombreCompleto, null);
        pnlMedico.add(jLabel4, null);
        pnlMedico.add(txtCmp, null);
        pnlMedico.add(jLabel2, null);
        //pnlPaciente.add();
        pnlPaciente.add(txtSexoPaciente, null);
        pnlPaciente.add(txtNacimientoPaciente, null);
        pnlPaciente.add(jButton3, null);
        pnlPaciente.add(txtApellidoPacienteMaterno, null);
        pnlPaciente.add(txtApellidoPacientePaterno, null);
        pnlPaciente.add(jLabel7, null);
        pnlPaciente.add(txtNombrePaciente, null);
        pnlPaciente.add(jLabel6, null);
        pnlPaciente.add(txtDniPaciente, null);
        pnlPaciente.add(jLabel5, null);
        // pnlClienteRUC.add();
    }
...
// **************************************************************************
  private void initialize()
  {
      ...
      tblModelEspecialidad = 
              new FarmaTableModel(ConstantsCaja.columnsListaEspecialidad, ConstantsCaja.defaultValuesListaEspecialidad, 
                                  0);
      
      FarmaUtility.initSimpleList(tblEspecialidad, 
                                  tblModelEspecialidad, ConstantsCaja.columnsListaEspecialidad);  
      
      tblModelDetalleProd = 
              new FarmaTableModel(ConstantsCaja.columnsListaDeta_Esp, ConstantsCaja.defaultValuesListaDeta_Esp, 
                                  0);
      
      FarmaUtility.initSimpleList(tblDetalleProd, 
                                  tblModelDetalleProd, ConstantsCaja.columnsListaDeta_Esp);  
    ...
    //respaldo de la variable de pedido base
    VariablesModuloVentas.vNumPedido_Base = VariablesModuloVentas.vNum_Ped_Vta;
    mostrarDetalleEspecialidad(true);
  }
...
//    if(Double.parseDouble(monto) <= 0)
  ...
  * */
  ...
  public void pedidoCobrado(){
	...
	if(VariablesCaja.vIndPedidoCobrado){
	    ...
	    if ( FarmaVariables.vTipCaja.equalsIgnoreCase(ConstantsPtoVenta.TIP_CAJA_MULTIFUNCIONAL) && 
                ...
                mostrarDetalleEspecialidad(false);
                
                boolean vExistePendienteCobro = false;
	        for(int i=0 ; i<tblEspecialidad.getRowCount();i++){
	            String pEstado = FarmaUtility.getValueFieldArrayList(tblModelEspecialidad.data, i, 1);
	            if(pEstado.equalsIgnoreCase("P")){
	                vExistePendienteCobro = true;
	                FarmaUtility.moveFocus(tblEspecialidad);
	                FarmaGridUtils.showCell(tblEspecialidad, i, 0);
	                muestraDetalleEspecialidad();
                        break;
	            }
	        }
                
                if(!vExistePendienteCobro)
                    cerrarVentana(true);
	    }
	    indBorra = true;
	    limpiarDatos();
  ...
  private boolean validaIngresoSobre() {
    ...
    private void procesoNuevoCobroFV() {
        ...
        //if (true){
                ...
                if (pValorSaldo == 0) {
                    ...
                    UtilityCaja.grabarNuevoCobro_HHSur(dlgNuevoCobro, this,myParentFrame);
                    pedidoCobrado();
                } else
    ...
    private void mostrarDetalleEspecialidad(boolean vProcesa) {
       ...
       // VariablesModuloVentas.vNum_Ped_Vta;
        try {
            ...
            VariablesModuloVentas.vNum_Ped_Vta = "";
            if(vProcesa){
                DBCaja.procesaPedidoEspecialidad(VariablesModuloVentas.vNumPedido_Base);
                FarmaUtility.aceptarTransaccion();
                
            }
            
            DBCaja.cargaListaCaja_Especialidad(tblModelEspecialidad, VariablesModuloVentas.vNumPedido_Base);
            tblEspecialidad.repaint();
            
            if(tblEspecialidad.getRowCount()>0){
                boolean pExistePendiente = false;
                // ubicar en la fila primera de estado P
                for(int i=0 ; i<tblEspecialidad.getRowCount();i++){
                    String pEstado = FarmaUtility.getValueFieldArrayList(tblModelEspecialidad.data, i, 1);
                    if(pEstado.equalsIgnoreCase("P")){
                        pExistePendiente = true;
                        FarmaUtility.moveFocus(tblEspecialidad);
                        FarmaGridUtils.showCell(tblEspecialidad, i, 0);
                        muestraDetalleEspecialidad();
                    }
                ...
                if(!pExistePendiente){
                    FarmaUtility.moveFocus(tblEspecialidad);
                    FarmaGridUtils.showCell(tblEspecialidad, 0, 0);
                }
    ...
    private void muestraDetalleEspecialidad(){
        try {
            String pNumPedido = FarmaUtility.getValueFieldArrayList(tblModelEspecialidad.data, tblEspecialidad.getSelectedRow(),3);
            DBCaja.cargaListaCaja_DetEspecialidad(tblModelDetalleProd, pNumPedido);
            tblDetalleProd.repaint();
            FarmaGridUtils.showCell(tblDetalleProd, 0, 0);
            
            
            VariablesModuloVentas.vNum_Ped_Vta = pNumPedido;
            
            VariablesCaja.vNumPedVta = FarmaUtility.getValueFieldArrayList(tblModelEspecialidad.data, tblEspecialidad.getSelectedRow(),3);
            VariablesCaja.vNumPedPendiente = FarmaUtility.getValueFieldArrayList(tblModelEspecialidad.data, tblEspecialidad.getSelectedRow(),4);
            VariablesCaja.vFecPedACobrar = FarmaUtility.getValueFieldArrayList(tblModelEspecialidad.data, tblEspecialidad.getSelectedRow(),5);
            
            String pEstado = FarmaUtility.getValueFieldArrayList(tblModelEspecialidad.data, tblEspecialidad.getSelectedRow(), 1);
            if(pEstado.equalsIgnoreCase("P"))
                carga_pedido_pendiente();
    ...
    private void tblEspecialidad_keyReleased(KeyEvent e) {
        if(tblEspecialidad.getRowCount()>0)
        muestraDetalleEspecialidad();
        
    }

    private void cargaDatosPedido_cobrar() {
    ...
    private void carga_pedido_pendiente() {
        indBorra=false;
    ...
    private void tblEspecialidad_mouseClicked(MouseEvent e) {
        ...
        int i= tblEspecialidad.getSelectedRow();
        ...
        if (e.getClickCount() == 2 && !e.isConsumed()) {
             e.consume();
             int vFoco = tblEspecialidad.getSelectedRow();
             //txtFiltroCategoria.setText(""+vFoco);
            if (tblEspecialidad.getSelectedRow() >= 0)
            { 
                 muestraDetalleEspecialidad();
             }
