...
public class DlgFiltroProductosVerPrecio extends JDialog 
{
    private static final Logger log = LoggerFactory.getLogger(DlgFiltroProductosVerPrecio.class);
...
// Constructores
// **************************************************************************
  public DlgFiltroProductosVerPrecio()
  {
    this(null, "", false);
  }

  public DlgFiltroProductosVerPrecio(Frame parent, String title, boolean modal)
  {
...
// **************************************************************************
  private void jbInit() throws Exception
  {
    ...
    jScrollPane1.setBounds(new Rectangle(15, 115, 415, 210));
    jScrollPane1.setBackground(new Color(255, 130, 14));
    pnlRelacionFiltros.setBounds(new Rectangle(15, 95, 415, 20));
    ...
    pnlIngresarProductos.setBounds(new Rectangle(15, 10, 415, 80));
    ...
    txtProducto.setBounds(new Rectangle(115, 45, 220, 20));
    ...
    btnProducto.setBounds(new Rectangle(10, 45, 60, 25));
...
// **************************************************************************
  ...
  private void cargaListaFiltros()
  {
    ...
    try
    {
            DBModuloVenta.cargaListaFiltroVerComp(tableModelListaFiltro,codigoCategoria, tipoProducto);
