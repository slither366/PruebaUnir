...
public class DlgImpresionGuia extends JDialog {
    private static final Logger log = LoggerFactory.getLogger(DlgImpresionGuia.class);
    ...
    public DlgImpresionGuia() {
       this(null, "", false,"");
    }
    
    public DlgImpresionGuia(Frame parent, String title, boolean modal, String pNumPedVta) {
    ...
    private void jbInit() throws Exception {
        ...
        this.setTitle("Informaci\u00f3n Adicional de impresion de Guia");
    ...
    private void this_windowOpened(WindowEvent e) {
        ...
        try {
            String datosAdicionales = DBReporte.obtenerDatosAdicionales_guia(pNumPedVta);
    ...
    private void guardarDatosAdicionales(String pGlosa){
        try {
            DBReporte.guardarDatosAdicionales_guia(pGlosa, pNumPedVta);
    ...
    private void generarPDF_Cotizacion(String pGlosa){
        ...
        try{
            FileInputStream fis = new FileInputStream(rutaJasper+"GuiaPedido_Dental_Tayloc.jasper");
