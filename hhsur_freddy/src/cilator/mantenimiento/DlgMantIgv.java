...
public class DlgMantIgv extends JDialog {
    private static final Logger log = LoggerFactory.getLogger(DlgMantIgv.class);
    ...
    public DlgMantIgv(Frame parent, String title, boolean modal)
    {
    ...
    private void jbInit() throws Exception 
    {
        ...
        this.setTitle("Mantenimiento Igv :");
        ...
        lblNroComprobante.setText("Actualizar por % :");
        ...
        lblTipoActual.setText("IGV  actual es :  18%");
    ...
    private void evento_f11() {
        ...
        if(!vValor){
            ...
            try {
                ...
                lblTipoActual.setText("IGV  actual es : "+txtTipoActual.getText());
