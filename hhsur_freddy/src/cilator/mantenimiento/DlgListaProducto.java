...
public class DlgListaProducto extends JDialog {
    private static final Logger log = LoggerFactory.getLogger(DlgListaProducto.class);
    Frame myParentFrame;
    ...
    public DlgListaProducto() {
        this(null, "", false);
    }

    public DlgListaProducto(Frame parent, String title, boolean modal) 
    ...
    private void jbInit() throws Exception {
        this.setSize(new Dimension(1232, 422));
        ...
        pnlBusqueda.setBounds(new Rectangle(10, 10, 1005, 30));
        pnlHeaderUsuarios.setBounds(new Rectangle(10, 45, 1205, 25));
        ...
        scrListaUsuarios.setBounds(new Rectangle(10, 70, 1205, 280));
    ...
    private void initTable() {
        tableModel =
                new FarmaTableModel(ContantsMantenimiento.columnsListaProductos, 
                                    ContantsMantenimiento.defaultValuesListaProductos,
                                    0);
        FarmaUtility.initSimpleList(tblListausuarios, 
                                    tableModel,
                                    ContantsMantenimiento.columnsListaProductos);
        cargaLista();
    }
    ...
    private void cargaLista() {
        try {
            DBMantenimiento.getListaProductos(tableModel);
    ...
    public void accion(String pTipo) {
        ...
        DlgMantProducto dlg = new DlgMantProducto(this.myParentFrame, "", true, pTipo,pId);
        dlg.setVisible(true);
