...
public class DlgMantCategoria extends JDialog {
    private static final Logger log = LoggerFactory.getLogger(DlgMantCategoria.class);
    ...
    public DlgMantCategoria() {
        this(null, "", false,"I","");
    }

    public DlgMantCategoria(Frame parent, String title, boolean modal, String pAccion,String pIdUpdate) 
    {
    ...
    private void jbInit() throws Exception 
    {
        ...
        this.setTitle("Mantenimiento Categoría :");
        ...
        lblNroComprobante.setText("Nueva Categoría:");
        ...
        lblTipoActual.setText("Codigo / Nombre Categor\u00eda : ");
    ...
    private void loadData(String pIdValor){
        try {
            ...
            DBMantenimiento.getCATEGORIAId(vDatos, pIdValor);
            if(vDatos.size()==1){
    ...
    private void grabar() {
            ...
            try {
                DBMantenimiento.grabaCATEGORIA(pTipo,pId,pInsert,pUpdate);
