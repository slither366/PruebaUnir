...
public class DlgMantTipo extends JDialog {
    private static final Logger log = LoggerFactory.getLogger(DlgMantTipo.class);
    ...
    public DlgMantTipo(Frame parent, String title, boolean modal, String pAccion,String pIdUpdate) {
    ...
    {
        this.setSize(new Dimension(492, 163));
        this.getContentPane().setLayout(borderLayout1);
        this.setTitle("Mantenimiento Tipo :");
        ...
        lblNroComprobante.setText("Nueva Tipo:");
        ...
        txtTipoActual.setBounds(new Rectangle(120, 50, 255, 20));
        ...
        lblTipoActual.setText("Codigo / Nombre Tipo :");
    ...
    private void grabar() {
            ...
            try {
                DBMantenimiento.grabaTipo(pTipo,pId,pInsert,pUpdate);
    ...
    private void loadData(String pIdValor){
        try {
            ...
            DBMantenimiento.getTipoId(vDatos, pIdValor);
            if(vDatos.size()==1){
