...
public class DlgListaCategoria extends JDialog {
    private static final Logger log = LoggerFactory.getLogger(DlgListaCategoria.class);
    Frame myParentFrame;
    ...
    public DlgListaCategoria() {
        this(null, "", false);
    }

    public DlgListaCategoria(Frame parent, String title, boolean modal) {
    ...
    private void jbInit() throws Exception {
        this.setSize(new Dimension(473, 422));
        ...
        pnlBusqueda.setBounds(new Rectangle(10, 10, 445, 30));
        pnlHeaderUsuarios.setBounds(new Rectangle(10, 45, 435, 25));
        ...
        scrListaUsuarios.setBounds(new Rectangle(10, 70, 435, 280));
        ...
        lblSalir.setBounds(new Rectangle(360, 360, 75, 20));
        ...
        this.setTitle("Lista Categorias");
    }
    ...
    private void initTable() {
        tableModel =
                new FarmaTableModel(ContantsMantenimiento.columnsListaCategoria, ContantsMantenimiento.defaultValuesListaCategoria,
                                    0);
        FarmaUtility.initSimpleList(tblListausuarios, tableModel,ContantsMantenimiento.columnsListaCategoria);
        cargaLista();
    }
    ...
    private void cargaLista() {
        try {
            DBMantenimiento.getListaCATEGORIAs(tableModel);
    ...
    public void accion(String pTipo) {
        ...
        DlgMantCategoria dlg = new DlgMantCategoria(this.myParentFrame, "", true, pTipo,pId);
        dlg.setVisible(true);
