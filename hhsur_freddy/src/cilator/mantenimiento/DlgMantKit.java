...
public class DlgMantKit extends JDialog {
    private static final Logger log = LoggerFactory.getLogger(DlgMantKit.class);
    ...
    public DlgMantKit(Frame parent, String title, boolean modal)
    {
    ...
    {
        this.setSize(new Dimension(496, 454));
        this.getContentPane().setLayout(borderLayout1);
        this.setTitle("Mantenimiento Kit :");
        ...
        pnlTitle.setBounds(new Rectangle(5, 10, 470, 85));
        ...
        lblNroComprobante.setText("Nombre de Kit :");
        lblNroComprobante.setMnemonic('N');
        lblNroComprobante.setBounds(new Rectangle(20, 50, 110, 15));
        lblNroComprobante.setForeground(new Color(0, 114, 169));
        lblNroComprobante.setFocusable(false);
        txtTipoActual.setBounds(new Rectangle(115, 45, 315, 20));
        ...
        btnF11.setBounds(new Rectangle(215, 395, 117, 20));
        btnEsc.setBounds(new Rectangle(360, 395, 117, 19));
        ...
        lblTipoActual.setBounds(new Rectangle(15, 5, 450, 30));
        lblTipoActual.setFont(new Font("SansSerif", 1, 14));
        jScrollPane1.setBounds(new Rectangle(5, 105, 470, 270));
        jLabel1.setText("[F1]  Asociar Productos");
        jLabel1.setBounds(new Rectangle(5, 390, 175, 25));
