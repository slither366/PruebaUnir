...
public class DlgListaTipo extends JDialog {
    private static final Logger log = LoggerFactory.getLogger(DlgListaTipo.class);
    Frame myParentFrame;
    ...
    public DlgListaTipo(Frame parent, String title, boolean modal) {
    ...
    private void jbInit() throws Exception {
        this.setSize(new Dimension(486, 422));
        ...
        pnlBusqueda.setBounds(new Rectangle(10, 10, 455, 30));
        pnlHeaderUsuarios.setBounds(new Rectangle(10, 45, 455, 25));
        ...
        scrListaUsuarios.setBounds(new Rectangle(10, 70, 455, 280));
        ...
        lblSalir.setBounds(new Rectangle(385, 360, 75, 20));
    ...
    private void initTable() {
        tableModel =
                new FarmaTableModel(ContantsMantenimiento.columnsListaTipo, ContantsMantenimiento.defaultValuesListaTipo,
                                    0);
        FarmaUtility.initSimpleList(tblListausuarios, tableModel,ContantsMantenimiento.columnsListaTipo);
        cargaLista();
    }
    ...
    private void cargaLista() {
        try {
            DBMantenimiento.getListaTipos(tableModel);
    ...
    public void accion(String pTipo) {
        ...
        DlgMantTipo dlg = new DlgMantTipo(this.myParentFrame, "", true, pTipo,pId);
        dlg.setVisible(true);
