...
public class DlgAdmCliente extends JDialog {
    private static final Logger log = LoggerFactory.getLogger(DlgAdmCliente.class);
    ...
    public DlgAdmCliente() {
        this(null, "", false);
    }

    public DlgAdmCliente(Frame parent, String title, boolean modal) {
    ...
    private void jbInit() throws Exception {
        this.setSize(new Dimension(435, 265));
